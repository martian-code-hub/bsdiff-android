...
Java_com_martian_bsdiff_BsdiffUtils_diff(JNIEnv *env, jclass clazz, jstring old_file,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_martian_bsdiff_BsdiffUtils_patch(JNIEnv *env, jclass clazz, jstring old_file,
